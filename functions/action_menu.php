...
class action_menu extends library{
    ...
    public function showMenu_byMultiLevel_mainMenuTraiCam($list_menu,$valParent_menu = 0,$lang, $level = 0){
        ...
        if ($cate_child) {
            ...
            foreach ($cate_child as $key => $item) {
                ...
                if ($url == '/san-pham') { 
                    $this->danhMucSanPham_m1($list_menu,$item[$this->nameColID_menu],$lang, $level+1);
                } else {
    ...
    /*-----------------------------*/
    public function showMenu_byMultiLevel_mainMenuMassi($list_menu,$valParent_menu = 0,$lang, $level = 0){
        $cate_child = array();
        foreach ($list_menu as $key => $item)
        {
            // Nếu là chuyên mục con thì hiển thị
        ...
        if ($cate_child) {
            ...
            foreach ($cate_child as $key => $item) {
                ...
                if($level == 0 && $row[$this->nameColTitle_menuLanguage] == "Trang chủ")
                 ...
                 if ($url == '/san-pham') {
                    $this->danhMucSanPham($list_menu,$item[$this->nameColID_menu],$lang, $level+1);
                 } else {
                    $this->showMenu_byMultiLevel_mainMenuMassi_2($list_menu,$item[$this->nameColID_menu],$lang, $level+1); 
                 }
    ...
    /*-----------------------------*/
    public function showMenu_byMultiLevel_mainMenuMassi_2($list_menu,$valParent_menu = 0,$lang, $level = 0){
        $cate_child = array();
        foreach ($list_menu as $key => $item)
        {
            // Nếu là chuyên mục con thì hiển thị
            ...
            foreach ($cate_child as $key => $item) {
                ...
                if($level == 0 && $row[$this->nameColTitle_menuLanguage] == "Trang chủ")
                 ...
                 if ($url == '/san-pham') {
                    ...
                    $this->showMenu_byMultiLevel_mainMenuMassi($list_menu,$item[$this->nameColID_menu],$lang, $level+1); 
                 }
    ...
    public function danhMucSanPham ($list_menu, $valParent_menu = 0, $lang, $level) {
        global $conn_vn;
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-3">
                                        <ul>';
                                            $this->danhMucSanPhamHai($list_menu,$col[0],$lang, $level+1);
                                    echo '</ul>
                                    </div>
                                    <div class="col-md-3">
                                        <ul>';
                                            $this->danhMucSanPhamHai($list_menu,$col[1],$lang, $level+1);
                                    echo '</ul>
                                    </div>
                                    <div class="col-md-3 ">
                                        <ul>';
                                            $this->danhMucSanPhamHai($list_menu,$col[2],$lang, $level+1);
                                    echo '</ul>
                                    </div>
                                    <div class="col-md-3 ">
                                        <ul>';
                                            $this->danhMucSanPhamHai($list_menu,$col[3],$lang, $level+1);
                                    echo '</ul>
                                    </div>                                                                
                                </div>                            
                            </div>
    ...
    public function danhMucSanPhamHai ($list_menu, $valParent_menu = 0, $lang, $level) {
        $cate_child = array();
        foreach ($list_menu as $key => $item)
        {
            // Nếu là chuyên mục con thì hiển thị
    ...
    public function danhMucSanPham_m1 ($list_menu, $valParent_menu = 0, $lang, $level) {
        $cate_child = array();
        foreach ($list_menu as $key => $item)
        {
            // Nếu là chuyên mục con thì hiển thị
        ...
        if ($cate_child) {
            echo '<ul>';
            foreach ($cate_child as $key => $item) {
                $this->danhMucSanPham_m2($list_menu,$item[$this->nameColID_menu],$lang, $level+1);
            }
            echo '</ul>';
        }
    }

    public function danhMucSanPham_m2 ($list_menu, $valParent_menu = 0, $lang, $level) {
        $cate_child = array();
        foreach ($list_menu as $key => $item)
        {
            // Nếu là chuyên mục con thì hiển thị
